...
public class UserBorrowBookUseCaseImpl implements UserBorrowBookUseCase {
    ...
    public void handle(UUID userId, UUID bookId) {
        ...
        if (user.exceedsMaximumNumberOfBooks()) {
            throw new IllegalStateException("This user exceeds the maximum number of books allowed to borrow at the same time.");
        }
